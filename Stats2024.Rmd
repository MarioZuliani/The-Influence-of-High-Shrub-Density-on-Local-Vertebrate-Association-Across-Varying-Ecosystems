...
### Work on inflection point
library(inflection)
f=function(x){(1/8*x+1/2*x^2)/(1+1/8*x+1/2*x^2)}
x = final_data$aridity
y = final_data$Average_Evenness
...
inflection_point <- final_data[which.min(final_data$y), ]
even_temp + geom_vline(xintercept = inflection_point$aridity, linetype = "dashed", color = "red")
