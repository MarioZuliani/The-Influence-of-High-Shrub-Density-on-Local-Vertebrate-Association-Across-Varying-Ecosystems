...
library(lmerTest)
library(performance)
model <- lmer(animals ~ shrub_density + aridity + mean_temp + mean_humidity + (1|year), data = final_data)
...
q_model_1 <- glm(animals ~ shrub_density + I(shrub_density^2) + aridity + I(aridity^2) + mean_temp + I(mean_temp^2) + mean_humidity + I(mean_humidity^2), data = final_data_2022)
q_model_1
